...
namespace DynamicDriving.TripManagement.Infrastructure.Migrations.TripManagement
{
    ...
    [Migration("20220712093054_AddCostToTrips")]
    partial class AddCostToTrips
    {
            ...
            modelBuilder.Entity("DynamicDriving.TripManagement.Domain.CitiesAggregate.City", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("df37415d-7702-4458-87ba-687f9d949093"),
                            Active = true,
                            Name = "Sabadell",
                            SoftDeleted = false
                        },
                        new
                        {
                            Id = new Guid("7b9437f5-6dad-420f-8de5-988f8e2d8f69"),
                            Active = true,
                            Name = "Barcelona",
                            SoftDeleted = false
                        });
